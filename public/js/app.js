(function() {
  ...
  var oppoenetUrl = 'http://localhost:3000/plain.html?id=' +gameid;
  gameIdQuery.innerHTML = '<a href="' +oppoenetUrl+ '" target="_blank">' +oppoenetUrl+ '</a>';

  var channel = 'Demo1--' + gameid;
  console.log('Channel: ' + channel);

  var pubnub = new PubNub({
    subscribeKey: 'sub-c-bb194474-3661-11e8-84f9-9e6f5e684596',
    publishKey: 'pub-c-f231fc04-1f11-40ee-9c13-e5efe9fba652',
    ssl: true
  });
